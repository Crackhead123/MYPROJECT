...
<body class="bg-dark">
    <div class="first">
        <form method="POST">
            <h1>Add Traveller</h1>
            <p>Name</p>
            <input class="textbox" type="text" name="fullname" placehoder="Enter Name" maxlength="16">
            <br>
            <br>
            <p>Age</p>
            <input class="textbox" type="age" name="age" placehoder="Enter age" maxlength="3">
            <br>
            <br>
            <p>Gender</p>
            <label><input class="radio" type="radio" name="gender" id="male" value="male">Male</label>
            <label><input class="radio" type="radio" name="gender" id="female" value="female">Female</label>
            <br>
            <br>
            ...
            <br>
            <button type="submit" name="submit" class="btn bg-primary text-white">Add Traveller</button>
        </form>
    </div>
</body>
</html>