    ...
    <div class="container">
      ...
      <form id="form" method="POST">
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            <div class="input-group-append">
              <button class="btn btn-outline-secondary bg-black" type="button" id="swap-button" onclick="swapStations()">
        ...
        <div class="form-group">
          ...
          <input class="form-control" type="date" id="select_date" name="select_date" required min="<?php echo date('Y-m-d'); ?>">
        </div>
        <div class="form-group">
          <select class="form-control" id="prefer" name="prefer" required>
            ...
            <option value="Person With Dissability">Person With Disability</option>
